...
const DepartmentCE = () => {
    ...
    // Scraped Data
    const about = {
        vision: "To produce professionally competent Civil Engineers with ethical values and social responsibility for the sustainable development of the nation.",
        mission: "To impart quality education with latest technological developments in Civil Engineering. To encourage students to pursue higher education and research. To inculcate ethical values and leadership qualities.",
        description: "Civil Engineering is one of the broadest and oldest of the engineering disciplines, extending across many technical specialties. A civil engineer requires not only a high standard of engineering knowledge but also supervisory and administrative skills. Civil Engineers plan, design, and supervise the construction of facilities essential to modern life needs. The Department of Civil Engineering was established in 2011 with an intake of 30. The Department is known for its reputed faculty having expertise in diverse fields. The Department offers a four-year course leading to B. Tech in Civil Engineering."
    };

    const peos = [
        "PEO 1: Acquire the fundamentals and core competence in basic sciences and civil engineering to identify, analyze and solve civil engineering problems.",
        "PEO 2: To grow professionally with self confidence adapting to changing circumstances and needs of the society.",
        "PEO 3: To work in teams and demonstrate leadership qualities with ethical values."
    ];
    ...
    const bosMembers = [
        { name: "Prof B. Jayarami Reddy", designation: "Principal, YSR Engineering College of Y.V. University", role: "External Member" },
        { name: "Dr. Syed Afzal Basha", designation: "Professor & Dean, Dept. of CE", role: "Chairman BOS" },
        { name: "Dr. D Ramaseshu", designation: "Professor, NIT Warangal", role: "External Member" },
    ];

    const facultyList = [
        { "sNo": "1", "name": "Dr. SYED AFZAL BASHA", "designation": "PROFESSOR & HEAD" },
        { "sNo": "2", "name": "Dr. SAKEVALA VINAY BABU", "designation": "PROFESSOR" },
        { "sNo": "3", "name": "Mr. SALE AKHIL TEJ", "designation": "ASST PROFESSOR" },
        { "sNo": "4", "name": "Mr. CHAKALI BALA HUSSAINY", "designation": "ASST PROFESSOR" },
        { "sNo": "5", "name": "Mr. CHEPPALI VENKATA SUKUMAR", "designation": "ASSOCIATE PROFESSOR" },
        { "sNo": "6", "name": "Mr. GAVVALA GANGADHARA SIVA", "designation": "ASST PROFESSOR" }
    ];

    // Standard Civil Engineering Labs assumed as specific names were extracted as "LAB 1" etc.
    const labs = [
    ...
    return (
        <Layout>
            <Helmet>
                <title>Civil Engineering | {collegeInfo.shortName}</title>
                <meta name="description" content="Department of Civil Engineering at GPCET." />
            </Helmet>
            ...
            >
                ...
                <div className="college-container relative z-10 h-full flex items-center">
                    <div>
                        ...
                        <h1 className="text-3xl md:text-5xl font-serif font-bold text-primary-foreground mb-4">Civil Engineering</h1>
                        <p className="text-primary-foreground/80 text-lg">Building the Foundation of Modern Society</p>
                    </div>
                </div>
            </section>
                    ...
                    <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
                                    ...
                                    <Card>
                                        ...
                                        <CardContent className="space-y-4">
                                            ...
                                            <div className="flex justify-between items-center">
                                                ...
                                                <span className="font-semibold text-right">Dr. Syed Afzal Basha</span>
                                            </div>
                                        </CardContent>
                                    </Card>
                                </div>
                        ...
                        <TabsContent value="events" className="space-y-6">
                            <div className="grid md:grid-cols-3 gap-6">
                                <a href="https://www.gpcet.ac.in/events-2/" target="_blank" rel="noopener noreferrer" className="block group">
